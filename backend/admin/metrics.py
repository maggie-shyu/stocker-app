...
from backend.models.api.admin import AdminOverview, AdminTablePage, AdminTableSummary
...
class AdminService:
    ...
    def __init__(self, client: Any):
        self._store = SupabaseAdminStore(client)
    ...
    def get_overview(self) -> AdminOverview:
        ...
        return AdminOverview(
            total_users=self._store.count_rows("user_settings", "user_id"),
            users_with_transactions=self._store.count_distinct_users("transactions"),
            users_with_cashflows=self._store.count_distinct_users("cashflow"),
    ...
    def list_tables(self) -> list[AdminTableSummary]:
        return [
            AdminTableSummary(
                ...
                row_count=self._store.count_rows(table_name, metadata["count_column"]),
            )
    ...
    def read_table(self, table_name: str, *, page: int, page_size: int) -> AdminTablePage:
        ...
        total, items = self._store.read_table_page(
            table_name,
            page=page,
            page_size=page_size,
