...
def test_export_escapes_formula_like_cell_values():
    mock_svc = app.dependency_overrides[get_supabase_service]()
...
def test_import_reads_workbook_and_replaces_data():
    ...
    transactions_sheet.append([
        ...
        "dividend_income", "reason"
    ])
    transactions_sheet.append([
        "2025-08-06", "買", "2330", "台積電", "一般",
        1000, 950, None, None, None, "imported"
    ])
...
def test_import_rejects_excessive_row_count(monkeypatch: pytest.MonkeyPatch):
    ...
    transactions_sheet.append(["2025-08-06", "買", "2330", "台積電", "一般", 1000, 950, None, None, None, None])
    transactions_sheet.append(["2025-08-07", "買", "2317", "鴻海", "一般", 1000, 200, None, None, None, None])
