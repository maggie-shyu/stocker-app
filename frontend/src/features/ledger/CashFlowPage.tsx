...
import { Button, Card, EmptyState, Field, PageHeader, SkeletonBlock } from "../../shared/ui/UI";
import { SortableHeader } from "./components/SortableHeader";
import { formatVisibleRowRange, useLedgerTable } from "./hooks/useLedgerTable";
import { useCashflows } from "./queries";
...
export function CashFlowPage() {
  ...
  const {
    ...
    items: data ?? [],
    initialSortKey: "date",
    getSortValue: (row: Cashflow, currentSortKey) =>
      (row as unknown as Record<string, string | number>)[currentSortKey] ?? "",
  });
